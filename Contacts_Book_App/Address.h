...
class Address {
    ...
    std::string Country;
public:
    Address(int num = 0, const std::string& streetname = "", const std::string& city = "", const std::string& country = "") :
    ...
    int getStreetnum() const { // o(1) time - o(1) memory
        return StreetNumber;
    }
    ...
    std::string toString() const {
        return std::to_string(StreetNumber) + " " + StreetName + ", " + City + ", " + Country;
    }
